...
static void
chmlib_chmfile_capsule_destructor(PyObject *chmfile_capsule)
{
...
static PyObject*
chmlib_chm_open(PyObject *self, PyObject *args)
{
    const char *filename;
...
static PyObject*
chmlib_chm_close(PyObject *self, PyObject *args)
{
...
static PyObject*
chmlib_chm_set_param(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
...
static int
chmlib_chm_enumerator(struct chmFile *h, struct chmUnitInfo *ui, void *context)
{
...
static PyObject*
chmlib_chm_enumerate_dir(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
    const char *prefix;
    int what;
...
static PyObject*
chmlib_chm_enumerate(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
    int what;
    PyObject *enumerator;
    ...
    if (!PyArg_ParseTuple(args, "OiOO:chmlib_chm_enumerate",
                          &chmfile_capsule, &what, &enumerator, &context))
        return NULL;
...
static PyObject*
chmlib_chm_resolve_object(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
    const char *path;
    struct chmUnitInfo ui;

    if (!PyArg_ParseTuple(args, "Os:chmlib_chm_resolve_object",
...
static PyObject*
chmlib_chm_retrieve_object(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
    ...
    res = chm_retrieve_object(chmfile, &ui, (unsigned char*)buf,
                              offset, length);
...
static PyObject *
chmlib_search(PyObject *self, PyObject *args)
{
    PyObject *chmfile_capsule;
    const char *text;
    int whole_words;
    ...
    if (!PyArg_ParseTuple(args, "OsiiO:chmlib_search", &chmfile_capsule,
...
void init_chmlib(void) {
    Py_InitModule("_chmlib", chmlib_methods);
}
