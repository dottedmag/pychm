...
def search(chmfile, text, whole_words, titles_only, dict):
    return _chmlib.search(chmfile, text, whole_words, titles_only, dict)
search = _chmlib.search

def is_searchable(file):
    return _chmlib.is_searchable(file)
is_searchable = _chmlib.is_searchable

def get_lcid(chmfile):
    return _chmlib.get_lcid(chmfile)
get_lcid = _chmlib.get_lcid
